...
declare namespace Polymer {
   ...
   * `aria-invalid` attribute.
   */
  function IronValidatableMixin<T extends new (...args: any[]) => {}>(base: T): T & IronValidatableMixinConstructor;

  interface IronValidatableMixinConstructor {
    new(...args: any[]): IronValidatableMixin;
  }

  interface IronValidatableMixin {
